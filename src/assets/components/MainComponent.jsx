      ...
      <div className="w-full pb-12 mt-[120px] flex flex-col items-center justify-center">
        ...
        <div className="w-full lg:w-11/12 flex flex-col lg:flex-row justify-center items-center mb-10">
          <div className="w-full lg:w-1/2 lg:order-2 p-6">
            <img
              ...
              src="https://i.ibb.co/7KrTPD7/crop1.jpg"
              alt="Blockchain and Farming"
            />
          </div>
          <div className="w-full lg:w-1/2 lg:order-1 p-6">
            ...
            <div className="text-lg font-bold mb-7 text-center">
              Blockchain technology is revolutionizing the agricultural sector
              in various ways:
            </div>
        ...
        <div className="w-full lg:w-11/12 flex flex-col lg:flex-row justify-center items-center mb-10">
          <div className="w-full lg:w-1/2 lg:order-1 p-6">
            <img
              className="w-full rounded-3xl"
              src="https://images.pexels.com/photos/235925/pexels-photo-235925.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              alt="Cryptocurrency Donations"
            />
          </div>
          <div className="w-full lg:w-1/2 lg:order-2 p-6">
            <div className="text-center text-green-500 text-4xl font-extrabold mb-7">
            ...
            <div className="flex justify-center">
              <Button variant="outlined" onClick={sendTx}>
                Donate
              </Button>
            </div>
          </div>
        ...
        <div className="w-full lg:w-11/12 flex flex-col lg:flex-row justify-center items-center mb-10">
          <div className="w-full lg:w-1/2 p-6">
            ...
            <div className="text-lg px-5 mb-7 text-center">
              Connect your Ethereum wallet to access additional features and
              services. Your connected wallet will display your account address
              and balance.
            </div>
            <div className="flex justify-center">
          ...
          <div className="w-full lg:w-1/2 p-6">
            <img
              className="w-full rounded-3xl"
              src="https://images.pexels.com/photos/14891535/pexels-photo-14891535.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
